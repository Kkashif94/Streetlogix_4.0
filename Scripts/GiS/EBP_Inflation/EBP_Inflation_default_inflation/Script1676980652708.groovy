...
WebUI.setText(findTestObject('Object Repository/EBP_Object/Page_Streetlogix/input_Scenario Name_scenarioName'), 'EBP_Inflation 2')
...
WebUI.click(findTestObject('EBP_Object/Page_Streetlogix/EBP_Inflation_2'))
...
WebUI.click(findTestObject('EBP_Object/Page_Streetlogix/Inflation_default'))
...
String TRC = WebUI.getText(findTestObject('Object Repository/EBP_Object/Page_Streetlogix/Total_Repairs'))

def total_repair = TRC.toInteger()

WebUI.verifyGreaterThan(total_repair, 20)

WebUI.verifyLessThanOrEqual(total_repair, 30)
