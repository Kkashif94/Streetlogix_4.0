...
WebUI.click(findTestObject('Work order 4.0/Page_Streetlogix/Workorder page objects/Page_Streetlogix/div_Daily'))

WebUI.click(findTestObject('Work order 4.0/Page_Streetlogix/Workorder page objects/Page_Streetlogix/li_Custom'))
...
WebUI.click(findTestObject('Work order 4.0/Page_Streetlogix/Workorder page objects/Page_Streetlogix/Equipment dropdown'))
...
WebUI.click(findTestObject('Work order 4.0/Page_Streetlogix/Workorder page objects/Page_Streetlogix/Material_dropdown'))
...
WebUI.click(findTestObject('Work order 4.0/Page_Streetlogix/Workorder page objects/Page_Streetlogix/Labor_dropdown'))
