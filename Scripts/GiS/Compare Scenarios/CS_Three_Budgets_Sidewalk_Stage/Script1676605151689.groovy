...
CustomKeywords.'gis_url.test.URL_Stage.redirectURL'()
...
WebUI.click(findTestObject('Compare Scenarios/div_Pavement Maintenance'))

WebUI.click(findTestObject('Compare Scenarios/li_Sidewalk Maintenance'))
...
WebUI.setText(findTestObject('Object Repository/Compare Scenarios/input_Annual Budget_budget'), '3000')

WebUI.setText(findTestObject('Compare Scenarios/input_Annual Budget_budget_2'), '2000')

WebUI.setText(findTestObject('Compare Scenarios/input_Annual Budget_budget_3'), '1000')
