...
WebUI.setText(findTestObject('Object Repository/Compare Scenarios/input_Scenario Name_scenario_name'), 'Compare Scenario 2')

WebUI.setText(findTestObject('Object Repository/Compare Scenarios/input_Annual Budget_budget'), '10,000')

WebUI.sendKeys(findTestObject('Object Repository/Compare Scenarios/Input_Inflation'), Keys.chord(Keys.COMMAND, 'a'))

WebUI.sendKeys(findTestObject('Object Repository/Compare Scenarios/Input_Inflation'), Keys.chord(Keys.DELETE))

WebUI.setText(findTestObject('Object Repository/Compare Scenarios/Input_Inflation'), '7')
