...
WebUI.setText(findTestObject('Object Repository/EBP_Object/Page_Streetlogix/input_Program duration_programDuration'), '3')

String AvgCI = WebUI.getText(findTestObject('EBP_Object/Page_Streetlogix/Average_condition_index'))

def AvgCIdouble = AvgCI.toDouble()
def AvgCIround = Math.round(AvgCIdouble)

def TargetCI = AvgCIround + 3
...
WebUI.setText(findTestObject('Object Repository/EBP_Object/Page_Streetlogix/input_Annual Inflation_annualInflation'), '7')
...
WebUI.click(findTestObject('EBP_Object/Page_Streetlogix/Load_Scenarioname_3'))
...
WebUI.click(findTestObject('Object Repository/EBP_Object/Page_Streetlogix/Program_duration_3year'))

WebUI.click(findTestObject('Object Repository/EBP_Object/Page_Streetlogix/Total cost estimated'))

WebUI.click(findTestObject('Object Repository/EBP_Object/Page_Streetlogix/Inflation_7'))
...
WebUI.click(findTestObject('Object Repository/EBP_Object/Page_Streetlogix/Final_Rating_3'))
...
public boolean isFileDownloaded(String fileName) {
	...
	// Usage:
	isFileDownloaded("Streetlogix-EST-3.pdf");
	isFileDownloaded("Streetlogix-EST-3.docx");
