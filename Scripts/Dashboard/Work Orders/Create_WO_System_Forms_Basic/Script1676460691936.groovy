...
//WebUI.click(findTestObject('Object Repository/WO_Dashboard/Page_Streetlogix  Dashboard/input_Repeating_repeating'))
//WebUI.click(findTestObject('Object Repository/WO_Dashboard/Page_Streetlogix  Dashboard/input_Repeating_repeating'))
//WebUI.setText(findTestObject('Object Repository/WO_Dashboard/Page_Streetlogix  Dashboard/input_test_testField'), '123')
WebUI.click(findTestObject('WO_Dashboard/Page_Streetlogix  Dashboard/Toggle_Equipment'))

WebUI.click(findTestObject('Object Repository/WO_Dashboard/Page_Streetlogix  Dashboard/svg_Equipment_MuiSvgIcon-root'))

WebUI.click(findTestObject('Object Repository/WO_Dashboard/Page_Streetlogix  Dashboard/li_Axe-Ton-20'))

WebUI.setText(findTestObject('Object Repository/WO_Dashboard/Page_Streetlogix  Dashboard/input__MuiInputBase-input MuiOutlinedInput-_2734f2'), 
    '10')

WebUI.click(findTestObject('Object Repository/WO_Dashboard/Page_Streetlogix  Dashboard/div_Add Item'))
